...
void loop() {
  ...
  // put your main code here, to run repeatedly:
    ...
    if(sqrt(Axyz[1]*Axyz[1]+Axyz[0]*Axyz[0])>1.2 && a_p>0 && a_r < 0){ red = 255;tone(tonePin, 293.6648,200);//front
    }
    else if(sqrt(Axyz[1]*Axyz[1]+Axyz[0]*Axyz[0])>1.2 && a_p>0 && a_r > 0){ green = 255;tone(tonePin, 329.6276,200);//Left
    }
    else if(sqrt(Axyz[1]*Axyz[1]+Axyz[0]*Axyz[0])>1.2 && a_p<0 && a_r > 0){ red = 255; green = 255; blue = 255;//backyard
    tone(tonePin, 349.2282,200);}
    else if(sqrt(Axyz[1]*Axyz[1]+Axyz[0]*Axyz[0])>1.2 && a_p<0 && a_r < 0){ blue = 255;
    tone(tonePin, 261.6256,200);//RIGHT
    }
